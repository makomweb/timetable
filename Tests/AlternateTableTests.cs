...
namespace Tests
{
    ...
    {
        private static DateTime _startDate = new DateTime(2018, 4, 11);
        ...
        {
            var table = _table.Get(new DateTime(2018, 4, 13));
        ...
        {
            var table = _table.Get(new DateTime(2018, 4, 17));
        ...
        {
            var table = _table.Get(new DateTime(2018, 4, 25));

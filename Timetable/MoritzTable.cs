...
namespace Timetable
{
    public class MoritzTable : Table
    {
        ...
        private static IEnumerable<Weekday> CreateWeekdays()
        {
            ...
            var tuesday = dayFactory.CreateWeekday("Tuesday", "Geschichte", "Musik", "Deutsch", "Deutsch", "ITG/WAT", "ITG/WAT");
            weekdays.Add(tuesday);

            var wednesday = dayFactory.CreateWeekday("Wednesday", "Französisch", "Englisch", "Mathematik", "Mathematik", "Sport", "Ethik", "AG", "AG");
            weekdays.Add(wednesday);

            var thursday = dayFactory.CreateWeekday("Thursday", "Bio/Ch/Ph", "Bio/Ch/Ph", "Französisch", "Französisch", "Ethik", "Mathematik", "Geo");
